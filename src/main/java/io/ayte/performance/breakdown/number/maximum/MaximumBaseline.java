...
/**
 * A benchmark that should provide baseline time for non-inlined
 * {@link Math#max(int, int)} equivalents: code which doesn't perform
 * comparison and directly instantly first argument.
 */
